    ...
    <div>
        ...
        <section className="projects__grid apps">
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal17(!estadoModal17)}>
              <img
                src={proyectsImgApp(`./proyecto-app-17.png`)}
                alt=""
                className="projects__img"
              />
            </a>
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal16(!estadoModal16)}>
              <img
                src={proyectsImgApp(`./pro_app/a_1.png`)}
                alt=""
                className="projects__img"
              />
            </a>
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal15(!estadoModal15)}>
              <img
                src={proyectsImgApp(`./pro_app/a_2.png`)}
                alt=""
                className="projects__img"
              />
            </a>
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal14(!estadoModal14)}>
              <img
                src={proyectsImgApp(`./pro_app/a_3.png`)}
                alt=""
                className="projects__img"
              />
            </a>
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal13(!estadoModal13)}>
              <img
                src={proyectsImgApp(`./pro_app/a_4.png`)}
                alt=""
                className="projects__img"
              />
            </a>
          ...
          <div className="projects__item">
            <a onClick={() => cambiarEstadoModal12(!estadoModal12)}>
              <img
                src={proyectsImgApp(`./pro_app/a_5.png`)}
                alt=""
                className="projects__img"
              />
            </a>
        ...
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview">
              <img src={proyectsImgApp(`./proyecto-app-18-com.png`)} alt="" />
            </div>
            <div className="eins-modal-text">
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span>{" "}
                <a href="https://coin-plus.vercel.app/" target="_blank">
                  https://coin-plus.vercel.app/
                </a>
              </div>
      ...
      <Modal estado={estadoModal17} cambiarEstado={cambiarEstadoModal17}>
        <div className="content-modal">
          <div className="pw-content">
            <div className="eins-modal-preview">
              <img src={proyectsImgApp(`./proyecto-app-17-com.png`)} alt="" />
            </div>
            <div className="eins-modal-text">
              <p>PI Dogs</p>
              <p>
              ...
              <div className="eins-modal-text-2">
                <span>Link:</span>{" "}
                <a href="https://pi-dogs-main-ashy.vercel.app/" target="_blank">
                  https://pi-dogs-main-ashy.vercel.app/
                </a>
              </div>
              <div className="eins-modal-text-3">
                <span>
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <h1>Project Goal</h1>
              <p>
                Our team was tasked with developing an all-encompassing podcast
                application, Ever.fm, that would offer users the convenience of
                listening to a vast range of podcasts while providing an
                engaging community platform for discussions.
              </p>
              <h1>Solutions</h1>
              <p>
                <FormattedMessage
              ...
              <div className="eins-modal-text-3">
                ...
                <div className="eins-modal-tec">
                  React Native, Fire CMS, Firebase, bitrise, fastlane, App
                  Center, AppsFlyer, Google cloud
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <h1>Project Goal</h1>
              <p>
                The main goal of the H-Surveys project was to develop a mobile
                application that can be used to conduct anonymous surveys for
                the validation and research of health products. The team aimed
                to create a platform that would provide higher data reliability
                for customers, and at the same time, be comfortable for the
                respondents. The H-surveys app was expected to address the
                limitations of web-based surveys and provide an easy-to-use
                platform for both researchers and respondents. The H-Surveys
                project aimed to offer a solution that would enable health
                researchers to collect more reliable data by leveraging the
                increasing penetration of mobile devices globally. H-Surveys is
                built using a cross-platform framework Flutter, so it runs on
              ...
              <div className="eins-modal-text-3">
                ...
                <div className="eins-modal-tec">
                  Kotlin, Swift, NodeJS, Firebase, codemagic, fastlane, branch,
                  Google cloud
                </div>
              </div>
            </div>
      ...
      <Modal estado={estadoModal14} cambiarEstado={cambiarEstadoModal14}>
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              <h1>
                Practice Manager: Client Portal for Paperless Medical Practice
              </h1>
              <h1>Role</h1>
              <p>
                Flutter Project Development and Maintenance for a Seamless
                Mobile App Experience
              </p>
              <h1>Project Goal</h1>
              <p>
                Our primary objective was to design and develop an innovative,
                user-friendly application that would revolutionize the way
                medical practices operate by transitioning them to a paperless
                environment. This comprehensive, all-in-one solution would serve
                as a doctor’s main assistant, streamlining various
                administrative tasks and improving overall practice efficiency.
                The application would facilitate efficient patient payment
                management, billing, debt tracking, appointment scheduling, and
                secure storage of electronic health records, among other
                features.To achieve this ambitious goal, we set out to tackle
                several key challenges, including seamless integration of
                payment systems, the capability to generate detailed superbills,
                ensuring secure and long-term storage of payment history, and
                creating an intuitive user interface for both medical
                professionals and patients. Ultimately, the project’s success
                would be measured not only by the app’s ability to efficiently
                manage administrative tasks but also by the satisfaction and
                positive feedback from its end-users: the medical professionals
                and their patients. By offering a secure, user-friendly, and
                easily accessible platform, our mission was to empower medical
                practitioners to provide better care and enhance the overall
                patient experience.
              </p>
              <h1>Solutions</h1>
              <p>
              ...
              <div className="eins-modal-text-3">
                ...
                <div className="eins-modal-tec">
                  Flutter, Python, Firebase, bitrise, fastlane, Codecov,
                  Appsflyer, branch, Google cloud, Amplitude
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <h1>Role</h1>
              <p>Flutter モバイルアプリ開発, Delivery, and Maintenance</p>
              <h1>Project Goal</h1>
              <p>
                Our objective was to develop a user-friendly and efficient
                mobile app for processing payments in the B2B market, with a
                focus on the unique needs of freelancers and the companies they
                serve. The app needed to cater to both parties – the specialist
                who wants a quick and secure method of receiving payments, and
                the company representative who wants to ensure the safe and
                efficient payment for services rendered.
              </p>
              <h1>Solutions</h1>
              <p>
                <FormattedMessage
              ...
              <div className="eins-modal-text-3">
                ...
                <div className="eins-modal-tec">
                  Flutter, Flamelink, Firebase, codemagic, fastlane, Codecov,
                  App Center, mixpanel, Google cloud, Amplitude
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="content-modal">
          <div className="pw-content">
            ...
            <div className="eins-modal-text">
              ...
              <h1>Introduction</h1>
              <p>
                Servisus is a mobile app designed to make everyday tasks easier
                for people in cities. The app allows customers to quickly
                connect with service providers to perform a variety of tasks,
                from general cleaning to math classes to even replacing a
                windshield. The project was undertaken with the goal of
                simplifying the process of finding local help for everyday
                tasks. With its intuitive UI/UX, fast checkout system, and
                categorized and localized system of services, Servisus makes it
                easy and efficient for both customers and service providers to
                connect and get things done.
              </p>
              <h1>Challenges</h1>
              <p>
                The development team faced several challenges during the
                development process of Servisus, such as creating a
                user-friendly UI/UX that works quickly and efficiently and
                implementing a fast and simple checkout system for both
                customers and service providers. In addition, the team needed to
                design a structured system of services that would make it easy
                for customers to post tasks and for service providers to create
                a portfolio of their skills and expertise.
              </p>
              <h1>Key Features</h1>
              <p>
                The fast and simple checkout system implemented by the
                development team is another key feature of Servisus. Customers
                can easily create an ad in the correct category and receive
                responses from potential service providers on the same day.
                After selecting a service provider, customers can easily pay for
                their services through the app. Additionally, customers can rate
                their service provider after the task is completed, which helps
                future customers make informed decisions when selecting a
                service provider. Overall, these features make Servisus an ideal
                solution for anyone looking to simplify their everyday tasks and
                find local help quickly and easily.
              </p>
              <h1>Solutions</h1>
              <p>
                <FormattedMessage
              ...
              <h1>Conclusion</h1>
              <p>
                Overall, the development team successfully created a mobile app
                that simplifies the process of finding local help for everyday
                tasks. Through the development of two separate applications, the
                team produced a user-friendly interface that performs with
                remarkable speed and efficacy tailored to the unique
                requirements of both clients and vendors. The structured system
                of services, categorized and localized, makes it easy for
                customers to post tasks and for service providers to create a
                portfolio of their skills and expertise. If you’re looking for a
                reliable and efficient way to find local help for everyday
                tasks, give Servisus a try.
              </p>
              <div className="eins-modal-text-3">
                <span>
                  <FormattedMessage
                ...
                <div className="eins-modal-tec">
                  Flutter, NodeJS, Firebase, bitrise, fastlane, Codecov,
                  mixpanel, Google cloud
                </div>
              </div>
            </div>
          </div>
